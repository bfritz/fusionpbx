<?php
	...
	//schema details
		...
		$apps[$x]['db'][0]['fields'][$y]['description'] = '';
		$y++;
		$apps[$x]['db'][0]['fields'][$y]['name']['text'] = 'smtp_host';
		$apps[$x]['db'][0]['fields'][$y]['name']['deprecated'] = 'smtphost';
		$apps[$x]['db'][0]['fields'][$y]['type'] = 'text';
		$apps[$x]['db'][0]['fields'][$y]['description'] = '';
		$y++;
		$apps[$x]['db'][0]['fields'][$y]['name']['text'] = 'smtp_secure';
		$apps[$x]['db'][0]['fields'][$y]['name']['deprecated'] = 'smtpsecure';
		$apps[$x]['db'][0]['fields'][$y]['type'] = 'text';
		$apps[$x]['db'][0]['fields'][$y]['description'] = '';
		$y++;
		$apps[$x]['db'][0]['fields'][$y]['name']['text'] = 'smtp_auth';
		$apps[$x]['db'][0]['fields'][$y]['name']['deprecated'] = 'smtpauth';
		$apps[$x]['db'][0]['fields'][$y]['type'] = 'text';
		$apps[$x]['db'][0]['fields'][$y]['description'] = '';
		$y++;
		$apps[$x]['db'][0]['fields'][$y]['name']['text'] = 'smtp_username';
		$apps[$x]['db'][0]['fields'][$y]['name']['deprecated'] = 'smtpusername';
		$apps[$x]['db'][0]['fields'][$y]['type'] = 'text';
		$apps[$x]['db'][0]['fields'][$y]['description'] = '';
		$y++;
		$apps[$x]['db'][0]['fields'][$y]['name']['text'] = 'smtp_password';
		$apps[$x]['db'][0]['fields'][$y]['name']['deprecated'] = 'smtppassword';
		$apps[$x]['db'][0]['fields'][$y]['type'] = 'text';
		$apps[$x]['db'][0]['fields'][$y]['description'] = '';
		$y++;
		$apps[$x]['db'][0]['fields'][$y]['name']['text'] = 'smtp_from';
		$apps[$x]['db'][0]['fields'][$y]['name']['deprecated'] = 'smtpfrom';
		$apps[$x]['db'][0]['fields'][$y]['type'] = 'text';
		$apps[$x]['db'][0]['fields'][$y]['description'] = '';
		$y++;
		$apps[$x]['db'][0]['fields'][$y]['name']['text'] = 'smtp_from_name';
		$apps[$x]['db'][0]['fields'][$y]['name']['deprecated'] = 'smtpfromname';
		$apps[$x]['db'][0]['fields'][$y]['type'] = 'text';
		$apps[$x]['db'][0]['fields'][$y]['description'] = '';
		$y++;
