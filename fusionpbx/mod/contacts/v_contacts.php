...
//show the content
	...
	echo "<tr>\n";
	echo th_order_by('type', 'Type', $order_by, $order);
	echo th_order_by('org', 'Organization', $order_by, $order);
	echo th_order_by('n_given', 'First Name', $order_by, $order);
	echo th_order_by('n_family', 'Last Name', $order_by, $order);
	echo th_order_by('nickname', 'Nickname', $order_by, $order);
	echo th_order_by('title', 'Title', $order_by, $order);
	echo th_order_by('role', 'Role', $order_by, $order);
	//echo th_order_by('email', 'Email', $order_by, $order);
	//echo th_order_by('url', 'URL', $order_by, $order);
	//echo th_order_by('tz', 'Time Zone', $order_by, $order);
	//echo th_order_by('note', 'Notes', $order_by, $order);
