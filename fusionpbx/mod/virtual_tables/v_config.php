<?php
	...
	$apps[$x]['permissions'][] = 'virtual_tables_view';
	$apps[$x]['permissions'][] = 'virtual_tables_add';
	$apps[$x]['permissions'][] = 'virtual_tables_edit';
	$apps[$x]['permissions'][] = 'virtual_tables_delete';
	$apps[$x]['permissions'][] = 'virtual_table_fields_view';
	$apps[$x]['permissions'][] = 'virtual_table_fields_add';
	$apps[$x]['permissions'][] = 'virtual_table_fields_edit';
	$apps[$x]['permissions'][] = 'virtual_table_fields_delete';
