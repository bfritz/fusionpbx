...
$order = $_GET["order"];
	...
	//$sql .= " where virtual_table_field_id = '$virtual_table_field_id' ";
	...
	//echo "	<input type='button' class='btn' name='' alt='add' onclick=\"window.location='v_virtual_table_data_types_name_value_edit.php'\" value='+'>\n";
	echo "</td>\n";
	echo "<tr>\n";
