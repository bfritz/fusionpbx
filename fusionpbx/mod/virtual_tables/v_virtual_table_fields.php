...
$order = $_GET["order"];
	...
	echo "	<a href='v_virtual_table_fields_edit.php?virtual_table_id=".$row[virtual_table_id]."' alt='add'>$v_link_label_add</a>\n";
	//echo "	<input type='button' class='btn' name='' alt='add' onclick=\"window.location='v_virtual_table_fields_edit.php'\" value='+'>\n";
	echo "</td>\n";
	echo "<tr>\n";
