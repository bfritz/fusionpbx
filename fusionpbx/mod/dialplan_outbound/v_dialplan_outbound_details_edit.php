	...
	//add or update the database
		if ($_POST["persistformvar"] != "true") {
			if ($action == "add" && permission_exists('outbound_route_add')) {
				...
				require_once "includes/header.php";
				echo "<meta http-equiv=\"refresh\" content=\"2;url=v_dialplan_outbound_edit.php?id=".$dialplan_include_uuid."\">\n";
				echo "<div align='center'>\n";
				echo "Add Complete\n";
				echo "</div>\n";
				require_once "includes/footer.php";
...
//begin the content
	...
	echo "<td width='70%' align='right'><input type='button' class='btn' name='' alt='back' onclick=\"window.location='v_dialplan_outbound_edit.php?id=".$dialplan_include_uuid."'\" value='Back'></td>\n";
	echo "</tr>\n";
