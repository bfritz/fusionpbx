<?php
	...
	$apps[$x]['permissions'][] = 'outbound_route_view';
	$apps[$x]['permissions'][] = 'outbound_route_add';
	$apps[$x]['permissions'][] = 'outbound_route_edit';
	$apps[$x]['permissions'][] = 'outbound_route_delete';
