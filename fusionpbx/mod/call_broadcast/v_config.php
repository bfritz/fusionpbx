<?php
	...
	//$apps[$x]['permissions'][] = 'auto_attendant_view';
	//$apps[$x]['permissions'][] = 'auto_attendant_add';
	//$apps[$x]['permissions'][] = 'auto_attendant_edit';
	//$apps[$x]['permissions'][] = 'auto_attendant_delete';
