...
$order = $_GET["order"];
	...
	echo "<tr>\n";
	echo "<td width='50%' nowrap><b>Call Center Tier List</b></td>\n";
	...
	echo "	<a href='v_call_center_tier_edit.php' alt='add'><img src='".$v_icon_add."' width='17' height='17' border='0' alt='add'></a>\n";
	...
	if ($result_count == 0) { //no results
		...
		foreach($result as $row) {
			...
			echo "		<a href='v_call_center_tier_edit.php?id=".$row[call_center_tier_id]."' alt='edit'><img src='".$v_icon_edit."' width='17' height='17' alt='edit' border='0'></a>\n";
			echo "		<a href='v_call_center_tier_delete.php?id=".$row[call_center_tier_id]."' alt='delete' onclick=\"return confirm('Do you really want to delete this?')\"><img src='".$v_icon_delete."' width='17' height='17' alt='delete' border='0'></a>\n";
