<?php
	...
	$apps[$x]['permissions'][] = 'time_conditions_view';
	$apps[$x]['permissions'][] = 'time_conditions_add';
	$apps[$x]['permissions'][] = 'time_conditions_edit';
	$apps[$x]['permissions'][] = 'time_conditions_delete';
