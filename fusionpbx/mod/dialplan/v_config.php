<?php
	...
	$apps[$x]['permissions'][] = 'dialplan_view';
	$apps[$x]['permissions'][] = 'dialplan_add';
	$apps[$x]['permissions'][] = 'dialplan_edit';
	$apps[$x]['permissions'][] = 'dialplan_delete';
	$apps[$x]['permissions'][] = 'dialplan_advanced_view';
	$apps[$x]['permissions'][] = 'dialplan_advanced_edit';
