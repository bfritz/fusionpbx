...
$order = $_GET["order"];
	...
	echo "	<a href='v_fifo_agent_languages_edit.php' alt='add'><img src='".$v_icon_add."' width='17' height='17' border='0' alt='add'></a>\n";
	...
	if ($resultcount == 0) { //no results
		...
		foreach($result as $row) {
			...
			echo "		<a href='v_fifo_agent_languages_edit.php?id=".$row[fifo_agent_language_id]."' alt='edit'><img src='".$v_icon_edit."' width='17' height='17' alt='edit' border='0'></a>\n";
			echo "		<a href='v_fifo_agent_languages_delete.php?id=".$row[fifo_agent_language_id]."' alt='delete' onclick=\"return confirm('Do you really want to delete this?')\"><img src='".$v_icon_delete."' width='17' height='17' alt='delete' border='0'></a>\n";
