...
$order = $_GET["order"];
	...
	if ($resultcount == 0) { //no results
		...
		foreach($result as $row) {
			...
			echo "		<a href='v_hardware_phones_edit.php?id=".$row[hardware_phone_id]."' alt='edit'><img src='".$v_icon_edit."' width='17' height='17' alt='edit' border='0'></a>\n";
			echo "		<a href='v_hardware_phones_delete.php?id=".$row[hardware_phone_id]."' alt='delete' onclick=\"return confirm('Do you really want to delete this?')\"><img src='".$v_icon_delete."' width='17' height='17' alt='delete' border='0'></a>\n";
