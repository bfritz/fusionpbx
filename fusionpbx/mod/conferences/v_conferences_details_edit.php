...
//show the content
	...
	echo "<td width='70%' align='right'><input type='button' class='btn' name='' alt='back' onclick=\"window.location='v_conferences_edit.php?id=".$dialplan_include_uuid."'\" value='Back'></td>\n";
	echo "</tr>\n";
