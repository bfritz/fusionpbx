...
// v_dialplan_details
	if ($action == "update") {
		...
		echo "	<a href='v_conferences_details_edit.php?id2=".$dialplan_include_uuid."' alt='add'>$v_link_label_add</a>\n";
		echo "</td>\n";
		echo "<tr>\n";
		...
		if ($resultcount == 0) {
			...
			foreach($result as $row) {
				...
				echo "		<a href='v_conferences_details_edit.php?id=".$row[dialplan_includes_detail_uuid]."&id2=".$dialplan_include_uuid."' alt='edit'>$v_link_label_edit</a>\n";
				echo "		<a href='v_conferences_details_delete.php?id=".$row[dialplan_includes_detail_uuid]."&id2=".$dialplan_include_uuid."' alt='delete' onclick=\"return confirm('Do you really want to delete this?')\">$v_link_label_delete</a>\n";
				echo "	</td>\n";
				echo "</tr>\n";
				if ($c==0) { $c=1; } else { $c=0; }
			} //end foreach
