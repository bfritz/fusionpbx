...
//show the content
	...
	if ($result_count > 0) {
		foreach($result as $row) {
			...
			echo "		<a href='v_menus_delete.php?id=".$row['menu_id']."&menu_guid=".$row['menu_guid']."' alt='delete' onclick=\"return confirm('Do you really want to delete this?')\">$v_link_label_delete</a>\n";
			echo "	</td>\n";
			echo "</tr>\n";
			if ($c==0) { $c=1; } else { $c=0; }
		} //end foreach
