<?php
	...
	$text['title-group_permissions']['pt-pt'] = "Permissѕes do Grupo";
	...
	$text['header-group_permissions']['pt-pt'] = "Permissѕes do Grupo";
	...
	$text['description-user_manager']['fr-fr'] = "Ajouter, щditer, supprimer et chercher des utilisateurs. ";

	$text['description-user_add']['en-us'] = "To add a user, please fill out this form completely. All fields are required. ";
	$text['description-user_add']['pt-pt'] = "Para adicionar um utilizador por favor preencha este formulсrio. Todos os campos sуo de preenchimento obrigatѓrio. ";
	$text['description-user_add']['fr-fr'] = "Afin d'ajouter des utilisateurs, remplissez complшtement ce formulaire. Tous les champs sont requis. ";

	$text['description-user_edit']['en-us'] = "Edit user information and group membership. ";
	$text['description-user_edit']['pt-pt'] = "Editar a informaчуo do utilizador e os membros do grupo. ";
	...
	$text['description-group_permissions']['pt-pt'] = "Atribua permissѕes para este grupo.";
	$text['description-group_permissions']['fr-fr'] = "Assigner des permissions р ce groupe.";
	...
	$text['label-first_name']['fr-fr'] = "Prщnom";

	$text['label-last_name']['en-us'] = "Last Name";
	$text['label-last_name']['pt-pt'] = "кltimo Nome";
	...
	$text['label-user_info']['pt-pt'] = "Informaчуo do Utilizador";
	...
	$text['label-additional_info']['pt-pt'] = "Informaчуo Adicional";
	...
	$text['label-time_zone']['pt-pt'] = "Fuso Horсrio";
	...
	$text['description-contact']['fr-fr'] = "Attacher un contact р ce compte utilisateur";
	...
	$text['description-status']['pt-pt'] = "Escolher o estado de presenчa do utilizador.";
	$text['description-status']['fr-fr'] = "Choisir l'щtat de prщsence de l'utilisateur.";

	$text['description-time_zone']['en-us'] = "Select the default time zone.";
	$text['description-time_zone']['pt-pt'] = "Escolha o time zone por omissуo.";
	$text['description-time_zone']['fr-fr'] = "Choisir le fuseau horaire par dщfaut.";
	...
	$text['option-logged_out']['fr-fr'] = "Dщconnectщ";
	...
	$text['option-do_not_disturb']['pt-pt'] = "Nуo Perturbar";
	$text['option-do_not_disturb']['fr-fr'] = "Ne pas Dщranger";
	...
	$text['button-create_account']['fr-fr'] = "Crщщ le Compte";
	...
	$text['button-delete']['pt-pt'] = "Remoчуo";
	...
	$text['button-restore']['pt-pt'] = "Restaurar Valores por Omissуo";
	...
	$text['message-add']['pt-pt'] = "Adiчуo Efectuada";
	$text['message-add']['fr-fr'] = "Ajoutщ";

	$text['message-update']['en-us'] = "Update Completed";
	$text['message-update']['pt-pt'] = "Actualizaчуo Efectuada";
	$text['message-update']['fr-fr'] = "Mis р Jour";

	$text['message-delete']['en-us'] = "Delete Completed";
	$text['message-delete']['pt-pt'] = "Remoчуo Efectuada";
	$text['message-delete']['fr-fr'] = "Supprimщ";

	$text['message-restore']['en-us'] = "Restore Completed";
	$text['message-restore']['pt-pt'] = "Restauraчуo Efectuada";
	$text['message-restore']['fr-fr'] = "Restaurщ";
	...
	$text['message-password_blank']['pt-pt'] = "O campo password nуo pode ser vazio.";
	$text['message-password_blank']['fr-fr'] = "Le mot de passe ne peut pas ъtre vide.";

	$text['message-password_mismatch']['en-us'] = "Passwords did not match.";
	$text['message-password_mismatch']['pt-pt'] = "As passwords nуo correspondem.";
