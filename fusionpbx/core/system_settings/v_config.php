<?php
	...
	$apps[$x]['permissions'][] = 'system_settings_view';
	$apps[$x]['permissions'][] = 'system_settings_add';
	$apps[$x]['permissions'][] = 'system_settings_edit';
	$apps[$x]['permissions'][] = 'system_settings_delete';
