<?php
	...
	$text['description-call_center_agent_status']['pt-pt'] = "Lista todas as chamadas do Call Center com a opзгo de alterar o estado de um ou mais agentes.";
	$text['description-call_center_agent_status']['fr-fr'] = "Liste tous les agents du centre d'appel avec la possibilitй de modifier l'йtat d'un ou plusieur agent.";

	$text['description-call_center_tiers']['en-us'] = "List all tiers. Tiers assign agents to queues.";
	$text['description-call_center_tiers']['pt-pt'] = "Lista todos os nнveis. Os nнveis atribuem agentes аs filas.";
	...
	$text['label-extension']['pt-pt'] = "Extensгo";
	$text['label-extension']['fr-fr'] = "Extension";

	$text['label-strategy']['en-us'] = "Strategy";
	$text['label-strategy']['pt-pt'] = "Estratйgia";
	$text['label-strategy']['fr-fr'] = "Strategie";

	$text['label-music_on_hold']['en-us'] = "Music on Hold";
	$text['label-music_on_hold']['pt-pt'] = "Mъsica em Espera";
	...
	$text['label-record_template']['fr-fr'] = "Modиle d'enregistrement";

	$text['label-time_base_score']['en-us'] = "Time Base Score";
	$text['label-time_base_score']['pt-pt'] = "Pontuaзгo baseada no tempo";
	$text['label-time_base_score']['fr-fr'] = "Score basй sur le temps";

	$text['label-max_wait_time']['en-us'] = "Max Wait Time";
	$text['label-max_wait_time']['pt-pt'] = "Tempo mбximo de espera";
	$text['label-max_wait_time']['fr-fr'] = "Max attente";

	$text['label-max_wait_time_with_no_agent']['en-us'] = "Max Wait Time with No Agent";
	$text['label-max_wait_time_with_no_agent']['pt-pt'] = "Tempo mбximo de espera sem agente";
	...
	$text['label-max_wait_time_with_no_agent_time_reached']['pt-pt'] = "Tempo mбximo de espera sem agente atingido";
	...
	$text['label-timeout_action']['pt-pt'] = "Acзгo de Timeout";
	$text['label-timeout_action']['fr-fr'] = "Action sur Timeout";

	$text['label-tier_rules_apply']['en-us'] = "Tier Rules Apply";
	$text['label-tier_rules_apply']['pt-pt'] = "Aplicar Regras de Nнvel";
	$text['label-tier_rules_apply']['fr-fr'] = "Appliquer la Rиgle de Tier";

	$text['label-tier_rule_wait_second']['en-us'] = "Tier Rule Wait Second";
	$text['label-tier_rule_wait_second']['pt-pt'] = "Regra de nнvel segundo espera";
	$text['label-tier_rule_wait_second']['fr-fr'] = "Attente en seconde de la Rиgle de Tier";

	$text['label-tier_rule_wait_multiply_level']['en-us'] = "Tier Rule Wait Multiply Level";
	$text['label-tier_rule_wait_multiply_level']['pt-pt'] = "Regra de nнvel de espera multiplicado pelo nнvel";
	$text['label-tier_rule_wait_multiply_level']['fr-fr'] = "Rиgle du Tier Attente multipliйe par niveau";

	$text['label-tier_rule_no_agent_no_wait']['en-us'] = "Tier Rule No Agent No Wait";
	$text['label-tier_rule_no_agent_no_wait']['pt-pt'] = "Regra de Nнvel Sem agente Sem espera";
	$text['label-tier_rule_no_agent_no_wait']['fr-fr'] = "Rиgle du Tier Pas d'Agent, Pas d'attente";

	$text['label-discard_abandoned_after']['en-us'] = "Discard Abandoned After";
	$text['label-discard_abandoned_after']['pt-pt'] = "Rejeiзгo abandonada depois";
	$text['label-discard_abandoned_after']['fr-fr'] = "Dйclarer abandonnй aprиs";
	...
	$text['label-abandoned_resume_allowed']['fr-fr'] = "Recupйration permise des Abandons";
	...
	$text['label-caller_id_name_prefix']['fr-fr'] = "Prйfixe sur le nom d'appelant";

	$text['label-description']['en-us'] = "Description";
	$text['label-description']['pt-pt'] = "Descriзгo";
	...
	$text['label-no_answer_delay_time']['fr-fr'] = "Delais de No Rйponse";

	$text['label-max_no_answer']['en-us'] = "Max No Answer";
	$text['label-max_no_answer']['pt-pt'] = "Nъmero mбximo de nгo respondidas";
	$text['label-max_no_answer']['fr-fr'] = "Max non rйponses";

	$text['label-wrap_up_time']['en-us'] = "Wrap Up Time";
	$text['label-wrap_up_time']['pt-pt'] = "Tempo de preparaзгo";
	...
	$text['description-extension']['pt-pt'] = "Introduza o nъmero da extensгo.";
	$text['description-extension']['fr-fr'] = "";

	$text['description-strategy']['en-us'] = "Select the queue ring strategy.";
	$text['description-strategy']['pt-pt'] = "Seleccione a estratйgia da fila.";
	$text['description-strategy']['fr-fr'] = "";

	$text['description-music_on_hold']['en-us'] = "Select the desired hold music.";
	$text['description-music_on_hold']['pt-pt'] = "Seleccione uma mъsica de espera.";
	...
	$text['description-record_template']['pt-pt'] = "Introduza um template de gravaзгo. \$\${base_dir}/recordings/archive/\${strftime(%Y)}/\${strftime(%b)}/\${strftime(%d)}/\${uuid}.wav";
	$text['description-record_template']['fr-fr'] = "Entrer un modиle d\'enregistrement. \$\${base_dir}/recordings/archive/\${strftime(%Y)}/\${strftime(%b)}/\${strftime(%d)}/\${uuid}.wav";
	...
	$text['description-max_wait_time']['pt-pt'] = "Introduzia o tempo mбximo de espera.";
	...
	$text['description-max_wait_time_with_no_agent']['pt-pt'] = "Introduza o tempo mбximo de espera sem agente.";
	...
	$text['description-max_wait_time_with_no_agent_time_reached']['pt-pt'] = "Introduza o tempo mбximo de espera atingido sem agente.";
	...
	$text['description-timeout_action']['pt-pt'] = "Defina a acзгo a realizar quando o tempo mбximo de espera for atingido.";
	...
	$text['description-tier_rules_apply']['pt-pt'] = "Defina a regra de nнvel a verdadeiro ou falso.";
	$text['description-tier_rules_apply']['fr-fr'] = "";

	$text['description-tier_rule_wait_second']['en-us'] = "Enter the tier rule wait seconds.";
	$text['description-tier_rule_wait_second']['pt-pt'] = "Introduza os segundos de espera da regra de nнvel.";
	...
	$text['description-tier_rule_wait_multiply_level']['pt-pt'] = "Defina a Regra de nнvel de espera multiplicado pelo nнvel.";
	...
	$text['description-discard_abandoned_after']['pt-pt'] = "Defina a rejeiзгo abandonada segundos depois.";
	...
	$text['description-abandoned_resume_allowed']['pt-pt'] = "Defina a permissгo para abadono do resume a verdadeiro ou a falso.";
	...
	$text['description-description']['pt-pt'] = "Introduza uma descriзгo, se desejar.";
	...
	$text['description-contact']['pt-pt'] = "Seleccione o nъmero de contacto.";
	...
	$text['description-no_answer_delay_time']['pt-pt'] = "Introduza o tempo de atraso em segundos do agente que nгo atende.";
	$text['description-no_answer_delay_time']['fr-fr'] = "";

	$text['description-max_no_answer']['en-us'] = "Enter max no answer.";
	$text['description-max_no_answer']['pt-pt'] = "Introduza o mбximo de nгo antedidas.";
	$text['description-max_no_answer']['fr-fr'] = "";

	$text['description-wrap_up_time']['en-us'] = "Enter the wrap up time.";
	$text['description-wrap_up_time']['pt-pt'] = "Introduza o tempo de preparaзгo.";
	$text['description-wrap_up_time']['fr-fr'] = "";

	$text['description-reject_delay_time']['en-us'] = "Enter the reject delay time.";
	$text['description-reject_delay_time']['pt-pt'] = "Introduza o tempo de atraso de rejeiзгo.";
	...
	$text['description-agent_logout']['pt-pt'] = "Introduza o tempo de logou automбtico do agente no formato 00:00. Isto requere um serviзo dedicado para forзar o logout.";
	$text['description-agent_logout']['fr-fr'] = "Entrer l'heure de dйconnexion automatique de l'agent au format 00:00. Nйcessite un service pour forcer la dйconnexion.";
	...
	$text['description-tier_level']['pt-pt'] = "Seleccione o nнvel da camada.";
	$text['description-tier_level']['fr-fr'] = "";

	$text['description-tier_position']['en-us'] = "Select the tier position.";
	$text['description-tier_position']['pt-pt'] = "Seleccione a posiзгo no nнvel.";
	...
	$text['option-longest_idle_agent']['pt-pt'] = "Agente desocupado hб mais tempo";
	$text['option-longest_idle_agent']['fr-fr'] = "Agent loguй depuis le plus lontemps";
	...
	$text['option-agent_with_least_talk_time']['pt-pt'] = "Agente com o menor tempo de comunicaзгo";
	...
	$text['option-agent_with_fewest_calls']['pt-pt'] = "Agente com o menor nъmero de chamadas";
	...
	$text['option-sequentially_by_agent_order']['fr-fr'] = "Sйquentiel par ordre d'agent";

	$text['option-sequentially_by_next_agent_order']['en-us'] = "Sequentially By Next Agent Order";
	$text['option-sequentially_by_next_agent_order']['pt-pt'] = "Sequencialmente pela ordem do prуximo agente";
	$text['option-sequentially_by_next_agent_order']['fr-fr'] = "Sйquentiel par ordre d'agent suivant";

	$text['option-random']['en-us'] = "Random";
	$text['option-random']['pt-pt'] = "Aleatуrio";
	$text['option-random']['fr-fr'] = "Alйatoire";

	$text['option-system']['en-us'] = "System";
	$text['option-system']['pt-pt'] = "sistema";
	$text['option-system']['fr-fr'] = "Systиme";
	...
	$text['option-logged_out']['fr-fr'] = "Dйconnectй";

	$text['option-available']['en-us'] = "Available";
	$text['option-available']['pt-pt'] = "Disponнvel";
	$text['option-available']['fr-fr'] = "Disponible";

	$text['option-available_on_demand']['en-us'] = "Available (On Demand)";
	$text['option-available_on_demand']['pt-pt'] = "Disponнvel (On Demand)";
	...
	$text['option-do_not_disturb']['pt-pt'] = "Nгo incomodar";
	...
	$text['button-advanced']['pt-pt'] = "Avanзadas";
	$text['button-advanced']['fr-fr'] = "Avancй";
	...
	$text['button-tiers']['pt-pt'] = "Nнveis";
	...
	$text['button-update_status']['fr-fr'] = "Mis а jour йtat";

	$text['button-refresh']['en-us'] = "Refresh";
	$text['button-refresh']['pt-pt'] = "Actualizar";
	$text['button-refresh']['fr-fr'] = "Rafraоchir";
	...
	$text['button-unload']['fr-fr'] = "dйcharger";
	...
	$text['message-add']['pt-pt'] = "Adiзгo Efectuada";
	$text['message-add']['fr-fr'] = "Ajoutй";

	$text['message-update']['en-us'] = "Update Completed";
	$text['message-update']['pt-pt'] = "Actualizaзгo Efectuada";
	$text['message-update']['fr-fr'] = "Mis а jour";

	$text['message-delete']['en-us'] = "Delete Completed";
	$text['message-delete']['pt-pt'] = "Remoзгo Efectuada";
	$text['message-delete']['fr-fr'] = "Supprimй";

	$text['message-copy']['en-us'] = "Copy Completed";
	$text['message-copy']['en-us'] = "Cуpia Efectuada";
	$text['message-copy']['fr-fr'] = "Copiй";
