...
//show the content
	...
	if ($action == "update") {
		...
		echo "  <input type='button' class='btn' value='Load' onclick=\"document.location.href='cmd.php?cmd=api+callcenter_config+queue+load+$queue_name@$domain_name';\" />\n";
		echo "  <input type='button' class='btn' value='Unload' onclick=\"document.location.href='cmd.php?cmd=api+callcenter_config+queue+unload+$queue_name@$domain_name';\" />\n";
		echo "  <input type='button' class='btn' value='Reload' onclick=\"document.location.href='cmd.php?cmd=api+callcenter_config+queue+reload+$queue_name@$domain_name';\" />\n";
	}
