...
CREATE TABLE v_call_broadcast (call_broadcast_id INTEGER PRIMARY KEY, v_id NUMERIC, broadcast_name TEXT, broadcast_desc TEXT, broadcast_timeout NUMERIC, broadcast_concurrent_limit NUMERIC, recordingid TEXT, broadcast_caller_id_name TEXT, broadcast_caller_id_number TEXT, broadcast_destination_type TEXT, broadcast_destination_data TEXT);
