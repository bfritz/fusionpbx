...
CREATE TABLE v_xml_cdr (xml_cdr_id SERIAL, v_id NUMERIC, uuid TEXT, direction TEXT, default_language TEXT, context TEXT, xml_cdr TEXT, caller_id_name TEXT, caller_id_number TEXT, destination_number TEXT, start_epoch NUMERIC, start_stamp TEXT, start_uepoch NUMERIC, answer_stamp TEXT, answer_epoch NUMERIC, answer_uepoch NUMERIC, end_epoch NUMERIC, end_uepoch NUMERIC, end_stamp TEXT, duration NUMERIC, mduration NUMERIC, billsec NUMERIC, billmsec NUMERIC, bridge_uuid TEXT, read_codec TEXT, write_codec TEXT, remote_media_ip TEXT, network_addr TEXT, hangup_cause TEXT, hangup_cause_q850 NUMERIC);
