--BEGIN TRANSACTION;
CREATE TABLE v_group_members (id SERIAL, v_id NUMERIC, groupid TEXT, username TEXT, CONSTRAINT  v_group_members_pk PRIMARY KEY(id));
...
CREATE TABLE v_groups (id SERIAL, v_id NUMERIC, groupid TEXT, groupdesc TEXT, CONSTRAINT  v_groups_pk PRIMARY KEY(id));
...
CREATE TABLE v_menu (menuid SERIAL, v_id NUMERIC, menulanguage TEXT, menutitle TEXT, menustr TEXT, menucategory TEXT, menugroup TEXT, menudesc TEXT, menuparentid TEXT, menuorder NUMERIC, menuadduser TEXT, menuadddate TEXT, menumoduser TEXT, menumoddate TEXT, CONSTRAINT  v_menu_pk PRIMARY KEY(menuid));
...
CREATE TABLE v_rss_sub_category ( rsssubcategoryid SERIAL, v_id NUMERIC, rsssubcategorylanguage TEXT, rsscategory TEXT, rsssubcategory TEXT, rsssubcategorydesc TEXT, rssadduser TEXT, rssadddate TEXT);
CREATE TABLE v_software (id SERIAL, v_id NUMERIC, software TEXT, softwarename TEXT, softwareurl TEXT, softwareversion TEXT);
...
CREATE TABLE v_auto_attendant (auto_attendant_id SERIAL, v_id NUMERIC, aaextension TEXT, aaname TEXT, recordingidaction TEXT, recordingidantiaction TEXT, aatimeout TEXT, aacalltimeout TEXT, aacontext TEXT, aadirectdial TEXT, aaringback TEXT, aacidnameprefix TEXT, aaconditionjs TEXT, aadescr TEXT);
...
CREATE TABLE v_call_broadcast (call_broadcast_id SERIAL, broadcast_name TEXT, broadcast_desc TEXT, broadcast_timeout NUMERIC, broadcast_concurrent_limit NUMERIC, recordingid TEXT, broadcast_caller_id_name TEXT, broadcast_caller_id_number TEXT, broadcast_destination_type TEXT, broadcast_destination_data TEXT);
...
CREATE TABLE v_public_includes (public_include_id SERIAL, v_id NUMERIC, extensionname TEXT, extensioncontinue TEXT, publicorder NUMERIC, context TEXT, opt1name TEXT, opt1value TEXT, enabled TEXT, descr TEXT);
INSERT INTO v_public_includes VALUES(1,1,'inbound01','',1,'',NULL,NULL,'true','inbound');
SELECT setval('v_public_includes_public_include_id_seq', (SELECT MAX(public_include_id) FROM v_public_includes)+1);
...
CREATE TABLE v_vars (v_id NUMERIC, var_id SERIAL, var_name TEXT, var_value TEXT, var_cat TEXT, var_enabled TEXT, var_order NUMERIC, var_desc TEXT);
...
CREATE TABLE v_hardware_phones (hardware_phone_id SERIAL, phone_mac_address TEXT, phone_vendor TEXT, phone_model TEXT, phone_provision_enable TEXT, phone_template TEXT, phone_username TEXT, phone_password TEXT, phone_description TEXT);
CREATE TABLE v_src (src_id SERIAL, v_id NUMERIC, type TEXT, last_mod TEXT, path TEXT);
CREATE TABLE v_xml_cdr (xml_cdr_id SERIAL, v_id NUMERIC, uuid TEXT, direction TEXT, default_language TEXT, context TEXT, xml_cdr TEXT, caller_id_name TEXT, caller_id_number NUMERIC, destination_number NUMERIC, start_epoch NUMERIC, start_stamp TEXT, start_uepoch NUMERIC, answer_stamp TEXT, answer_epoch NUMERIC, answer_uepoch NUMERIC, end_epoch NUMERIC, end_uepoch NUMERIC, end_stamp TEXT, duration NUMERIC, mduration NUMERIC, billsec NUMERIC, billmsec NUMERIC, bridge_uuid TEXT, read_codec TEXT, write_codec TEXT, remote_media_ip TEXT, network_addr TEXT, hangup_cause TEXT, hangup_cause_q850 NUMERIC);
CREATE TABLE v_services (service_id SERIAL, v_id TEXT, v_service_name TEXT, v_service_type TEXT, v_service_data TEXT, v_service_cmd_start TEXT, v_service_cmd_stop TEXT, v_service_desc TEXT);
