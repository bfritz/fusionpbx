...
CREATE TABLE v_call_center_queue (call_center_queue_id SERIAL, v_id TEXT, queue_name TEXT, queue_extension TEXT, queue_strategy TEXT, queue_moh_sound TEXT, queue_record_template TEXT, queue_time_base_score TEXT, queue_max_wait_time NUMERIC, queue_max_wait_time_with_no_agent NUMERIC, queue_tier_rules_apply TEXT, queue_tier_rule_wait_second NUMERIC, queue_tier_rule_no_agent_no_wait TEXT, queue_discard_abandoned_after NUMERIC, queue_abandoned_resume_allowed TEXT, queue_tier_rule_wait_multiply_level TEXT, queue_description TEXT);
CREATE TABLE v_call_center_agent (call_center_agent_id SERIAL, v_id TEXT, agent_name TEXT, agent_type TEXT, agent_call_timeout NUMERIC, agent_contact TEXT, agent_status TEXT, agent_max_no_answer NUMERIC, agent_wrap_up_time NUMERIC, agent_reject_delay_time NUMERIC, agent_busy_delay_time NUMERIC);
CREATE TABLE v_call_center_tier (call_center_tier_id SERIAL, v_id TEXT, agent_name TEXT, queue_name TEXT, tier_level NUMERIC, tier_position NUMERIC);
