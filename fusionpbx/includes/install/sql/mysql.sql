...
INSERT INTO v_group_members VALUES(2,1,'admin','admin');
INSERT INTO v_group_members VALUES(3,1,'admin','superadmin');
INSERT INTO v_group_members VALUES(4,1,'member','superadmin');
INSERT INTO v_group_members VALUES(5,1,'superadmin','superadmin');
CREATE TABLE v_groups (id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, v_id NUMERIC, groupid TEXT, groupdesc TEXT);
INSERT INTO v_groups VALUES(1,1,'admin','Administrator Group');
INSERT INTO v_groups VALUES(2,1,'member','Member Group');
INSERT INTO v_groups VALUES(3,1,'hidden','Hidden Group hides items in the menu');
INSERT INTO v_groups VALUES(4,1,'superadmin','Super Administrator Group');
...
CREATE TABLE v_xml_cdr (xml_cdr_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, v_id NUMERIC, uuid TEXT, direction TEXT, default_language TEXT, context TEXT, xml_cdr TEXT, caller_id_name TEXT, caller_id_number NUMERIC, destination_number NUMERIC, start_epoch NUMERIC, start_stamp TEXT, start_uepoch NUMERIC, answer_stamp TEXT, answer_epoch NUMERIC, answer_uepoch NUMERIC, end_epoch NUMERIC, end_uepoch NUMERIC, end_stamp TEXT, duration NUMERIC, mduration NUMERIC, billsec NUMERIC, billmsec NUMERIC, bridge_uuid TEXT, read_codec TEXT, write_codec TEXT, remote_media_ip TEXT, network_addr TEXT, hangup_cause TEXT, hangup_cause_q850 NUMERIC);
...
CREATE TABLE v_call_center_queue (call_center_queue_id INTEGER PRIMARY KEY, v_id TEXT, queue_name TEXT, queue_extension TEXT, queue_strategy TEXT, queue_moh_sound TEXT, queue_record_template TEXT, queue_time_base_score TEXT, queue_max_wait_time NUMBER, queue_max_wait_time_with_no_agent NUMBER, queue_tier_rules_apply TEXT, queue_tier_rule_wait_second NUMBER, queue_tier_rule_no_agent_no_wait TEXT, queue_discard_abandoned_after NUMBER, queue_abandoned_resume_allowed TEXT, queue_tier_rule_wait_multiply_level TEXT, queue_description TEXT);
CREATE TABLE v_call_center_agent (call_center_agent_id INTEGER PRIMARY KEY, v_id TEXT, agent_name TEXT, agent_type TEXT, agent_call_timeout NUMBER, agent_contact TEXT, agent_status TEXT, agent_max_no_answer NUMBER, agent_wrap_up_time NUMBER, agent_reject_delay_time NUMBER, agent_busy_delay_time NUMBER);
CREATE TABLE v_call_center_tier (call_center_tier_id INTEGER PRIMARY KEY, v_id TEXT, agent_name TEXT, queue_name TEXT, tier_level NUMBER, tier_position NUMBER);
