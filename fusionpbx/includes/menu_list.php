		...
		foreach($result as $field) {
			...
			if ($menulevel == "main") {
				...
				if ($menutitle == "Login" && strlen($_SESSION["username"]) > 0) {
					...
					$dbmenu .= "<a $menutags style='padding: 0px 0px; border-style: none; background: none;'>";
					//$dbmenu .= "<h2 align='center' style=''>";
					$dbmenu .= "$menutitle";
					//$dbmenu .= "</h2>";
					$dbmenu .= "</a>\n";
	...
	function builddbchildmenu($db, $menulevel, $menuid) {
			...
			$menulevel = $menulevel+1;
				...
				//--- Begin check for children -----------------------------------------
					...
					$sql .= "and length(menudeldate) = 0 ";
					$sql .= "or v_id = '$v_id' ";
					$sql .= "and menuparentid = '$menuid'  ";
					$sql .= "and menudeldate is null ";
					$sql .= "order by menuorder asc ";
...
//echo "groups:".$_SESSION["groups"]."<br>";
